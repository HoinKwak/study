#!/bin/bash
# 1h/15m klines monthly zip 다운로드 (2021-09 ~ 2026-06, AR스프레드 20일 롤링 창(1h=480봉)+
# 30일 백분위창(1h=720봉) 워밍업 확보를 위해 IS_START(2022-01-01)보다 앞서 2021-09부터 수신,
# OOS_END=2026-06-30 커버). 선례(oi-ar1-half-life-regime-breakout-scalp/dl_klines.sh) 패턴 재사용.
SP=/tmp/claude-0/-home-user-study/5c4aa354-51d8-5c5e-afb3-edb007c0a106/scratchpad/abdiranaldo
