"""수익률 1차 자기상관 부호전환 레짐스위치 스캘프 — 공통 데이터 로더 + 기본 상수.
...
SP = Path(os.environ.get(
    "RACSR_SCRATCH",
    "/tmp/claude-0/-home-user-study/5c4aa354-51d8-5c5e-afb3-edb007c0a106/scratchpad/racsr"))
DATA = SP / "data"
...
def prefetch(symbols=SYMBOLS, tfs=("15m", "1h"),
