...
## 시장 전반 — ACE 재가속(40%대 진입)·CASHCAT 3소스 수렴·Bybit 직접API 403 회귀
...
**데이터 품질 — Bybit 직접 API가 이번 회차 다시 403으로 회귀했다.** 지난 회차 "대부분
심볼에서 복구"됐던 것과 반대로, ACEUSDT·AEONUSDT·APEXUSDT·KAITOUSDT·BEATUSDT·
BICOUSDT 등 시도한 전 심볼에서 403이 재현됐다 — CoinGecko `derivatives/exchanges/bybit`
경유로 대체 확보했다(수치 자체는 정상 확보). **funding 스케일 스팟체크**: 이번 회차 OKX
14개 심볼(KAITO·BEAT·BICO·ATOM·CAP·BSB·ADA·APR·MMT·AEON·CORE·GRAM·GIGGLE·PIPPIN)의
`public/funding-rate`를 직접 재조회한 결과 전부 raw fraction 범위(|funding|<0.01)에 있어
신규 스케일 이상은 발견되지 않았다 — 지난 회차 발견된 KAITO·BICO·BEAT 오류는 재발하지
않았다.
...
|---|---|---|---|---|---|---|---|
| **ACE** [재가속] | Binance+Bybit(가중평균) | $717.23M | $27.80M | -0.15125 | +41.658% | WebSearch로도 신규 촉매 미확인, 원인 계속 미상 | ace-accelerates-again-cause-still-unconfirmed |
...
| **AAVE** [플러토 8회차] | Binance+Bybit(가중평균) | $55.77M | $84.15M | 0.003789 | +0.584% | 폭 추가 축소 | aave-plateau-decelerates-eighth-round |
...
| **ATOM** [4벤뉴 플러스 2회차] | Binance+Bybit(가중평균) | $20.08M | $30.08M | -0.02090 | +0.848% | 방향 유지 | atom-holds-positive-second-round-four-venues |
| ATOM [4벤뉴 플러스 2회차] | OKX(직접API) | $4.04M | $3.81M | -0.0001691 | +0.778% | 폭은 감속 | atom-holds-positive-second-round-four-venues |
| **ASTER** [CEX OI 안정화] | Binance+Bybit(가중평균) | $17.20M | $109.61M | 0.002684 | +0.116% | OI 급감이 이번 회차 안정화 | aster-cex-oi-stabilizes-after-halving |
| **AIO** [개선 3회차] | Binance+Bybit(가중평균) | $52.47M | $5.97M | 0.005 | -13.987% | 낙폭 추가 축소 | aio-continues-improving-third-round |
| **1000RATS** [4회차 플러스] | Binance+Bybit(가중평균) | $98.83M | $18.14M | 0.03408 | +11.171% | 급등 폭 지속 축소 | 1000rats-continues-decelerating-fourth-round |
| ALGO [무변화 지속] | Binance+Bybit(가중평균) | $7.89M | $13.74M | -0.01798 | -1.162% | 범위 내 소폭 악화 | algo-remains-roughly-flat-continues |
...
| AEON [진정 4회차] | Bybit(CoinGecko대체) | $8.42M | $1.22M | 0.005 | +4.918% | 직접API 403 회귀로 CoinGecko 경유 | aeon-moderation-continues-fourth-round |
...
| **ADA** [마이너스 유지] | Binance+Bybit(가중평균) | $124.63M | $137.54M | 0.004682 | -0.401% | Aster만 이탈, 소스 간 분기 | ada-holds-negative-aster-diverges-positive |
...
| **ALLO** [마이너스 반전] | Binance+Bybit(가중평균) | $46.73M | $16.64M | 0.000729 | -1.921% | 플러스에서 마이너스로 반전 | allo-flips-negative |
| **APEX** [방향유지 3회차] | Bybit(CoinGecko대체) | $0.95M | $1.57M | 0.005 | +1.918% | 직접API 403 회귀로 CoinGecko 경유 | apex-holds-positive-third-round |
| **BANK** [가격 추가 상승] | Binance+Bybit(가중평균) | $23.83M | $15.62M | -0.00133 | +3.966% | OI 안정 속 가격 상승세 확대 | bank-price-accelerates-oi-stable |
| **APR** [방향유지 4회차] | Binance+Bybit(가중평균) | $76.27M | $14.34M | 0.005 | +9.383% | 소폭 재가속 | apr-holds-positive-fourth-round |
...
|---|---|---|---|---|---|---|---|
| **ACE** [재가속] | Hyperliquid | $3.73M | $2.03M | -0.034 | +42.218% | B+B·Aster와 동조 추가 가속 | ace-accelerates-again-cause-still-unconfirmed |
| ACE [서비스 중단] | OrangeX | — | — | — | — | 29회차·약 59.75시간 | orangex-service-outage-continues |
| **ACE** [재가속] | Aster | $0.80M | $0.28M | -0.026 | +41.419% | HL·B+B와 동조 | ace-accelerates-again-cause-still-unconfirmed |
| BANK [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| **BANK** [가격 추가 상승] | Aster | $0.03M | $0.28M | 0.001 | +5.278% | 자체 OI는 거의 무변화 유지 | bank-price-accelerates-oi-stable |
| KAITO [손익분기 근접 4회차] | Hyperliquid | $3.16M | $5.75M | -0.001 | -1.766% | OKX·Binance와 동조 개선 | kaito-nears-breakeven-fourth-round |
| KAITO [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| CAP [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| **CAP** [플러스권 회복] | Aster | $0.07M | $0.19M | -0.002 | +0.956% | OKX와 함께 플러스로 회복 반전 | cap-recovers-toward-flat-after-reversal |
| BICO [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| **BICO** [플러토 4회차] | Aster | $0.10M | $0.09M | -0.146 | -3.201% | OKX·Binance와 동조 | bico-plateaus-near-breakeven-fourth-round |
| BSB [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| **BSB** [플러스 수렴] | Aster | $0.11M | $0.12M | 0.001 | +0.794% | OKX와 함께 플러스로 수렴 | bsb-converges-positive-both-sources |
| BLESS [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| BLESS [악화 지속] | Aster | $0.04M | $0.10M | 0.005 | -7.039% | 재악화 폭 더 커짐 지속 | bless-worsens-further-continues |
| **CASHCAT** [3소스 수렴] | Hyperliquid | $7.20M | $13.38M | 0.001 | -13.476% | 온체인·Aster와 함께 뚜렷한 마이너스로 수렴 | cashcat-three-sources-converge-negative |
| CASHCAT [서비스 중단] | OrangeX | — | — | — | — | 4소스 비교 핵심 축 공백 | orangex-service-outage-continues |
| **CASHCAT** [3소스 수렴] | Aster | $0.02M | $0.71M | -0.003 | -13.579% | HL·온체인과 수렴 — 거래량 급감(1/60) | cashcat-three-sources-converge-negative |
| AEON [진정 4회차] | Aster | $0.07M | $0.33M | 0.001 | +5.866% | OKX·Bybit와 5%대 수렴 유지 | aeon-moderation-continues-fourth-round |
| AEON [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| BEAT [소폭 악화] | Aster | $0.37M | $0.17M | 0.001 | -19.858% | OKX·Binance와 달리 소폭 더 악화 | beat-stabilizes-still-deeply-negative |
...
| GRAM [플러토 지속] | Hyperliquid | $1.83M | $15.38M | 0.001 | -0.52% | OKX와 함께 손익분기권 플러토 | gram-plateaus-near-flat |
| **BTW** [확장 4회차] | Aster | $1.07M | $11.22M | 0.01 | +17.142% | 확장 지속 | btw-continues-expanding-fourth-round |
| HYNA:PUMP [개선] | Hyperliquid | $0.04M | $0.18M | 0.006 | -0.423% | 낙폭 축소 지속 | updates-normally-no-stale-recurrence |
| HYNA:HYPE [플러스 반전] | Hyperliquid | $0.09M | $0.65M | 0.001 | +0.923% | HYPE(HL)와 동조 반전 | hype-flips-positive-again |
| HYNA:SOL-USD [소폭 상승] | Hyperliquid | $0.03M | $0.54M | 0.001 | +1.483% | SOL(dYdX)과 동조 | majors-sol-decelerates-still-positive |
| HYNA:BTC-USD [안정] | Hyperliquid | $0.53M | $2.20M | 0.001 | +0.653% | BTC와 동조 대체로 안정 | majors-btc-eth-stabilize-after-deceleration |
| HYNA:ETH-USD [안정] | Hyperliquid | $0.24M | $1.63M | 0.001 | +0.262% | ETH(HL)과 동조 안정 | majors-btc-eth-stabilize-after-deceleration |
| SOL [미확인] | Hyperliquid | — | — | — | — | 별도 티커 부재 지속 | remains-unconfirmed-no-separate-market |
| **1000RATS** [4회차 플러스] | Aster | $0.27M | $0.05M | 0.006 | +10.795% | B+B와 함께 폭 지속 축소 | 1000rats-continues-decelerating-fourth-round |
| AIO [개선 3회차] | Aster | $0.17M | $0.09M | 0.005 | -14.737% | B+B와 동조 개선 지속 | aio-continues-improving-third-round |
| AIO [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| AAVE [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| AAVE [플러토 8회차] | Aster | $0.19M | $4.48M | 0.01 | +0.718% | 폭 추가 축소 | aave-plateau-decelerates-eighth-round |
| AAVE [플러토 8회차] | Hyperliquid | $3.40M | $57.65M | 0.001 | +0.42% | B+B·Aster와 동조 감속 | aave-plateau-decelerates-eighth-round |
| ADA [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| **ADA** [소스 분기] | Aster | $0.17M | $1.20M | 0.01 | +0.116% | B+B·HL과 달리 근소 플러스 | ada-holds-negative-aster-diverges-positive |
| **ADA** [마이너스 유지] | Hyperliquid | $5.32M | $29.10M | 0.001 | -0.374% | B+B·OKX와 동조 마이너스 유지 | ada-holds-negative-aster-diverges-positive |
| ALGO [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| ALGO [무변화] | Aster | $0.01M | $0.04M | 0.001 | -0.599% | 초저활동 시장, 값 변동 미미 | algo-remains-roughly-flat-continues |
| ALGO [무변화] | Hyperliquid | $0.32M | $1.88M | -0.002 | -0.924% | B+B·Aster와 함께 대체로 무변화 | algo-remains-roughly-flat-continues |
| ASTER [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| **ASTER** [자체 OI 안정] | Aster | $11.85M | $221.90M | 0.006 | +0.166% | 자체 OI 안정 — CEX OI도 안정화 | aster-cex-oi-stabilizes-after-halving |
| ASTER [자체 OI 안정] | Hyperliquid | $0.58M | $13.55M | 0.001 | +0.108% | Aster프로토콜과 동조 안정 | aster-cex-oi-stabilizes-after-halving |
...
| **ETH** [안정화] | Hyperliquid | $665.38M | $1,764.97M | 0.001 | +0.283% | dYdX와 함께 안정화 | majors-btc-eth-stabilize-after-deceleration |
| ATOM [4벤뉴 플러스 2회차] | Hyperliquid | $0.44M | $1.71M | -0.004 | +0.897% | B+B·OKX·Aster와 동조 유지 | atom-holds-positive-second-round-four-venues |
| BTC [안정화] | Aster | $578.31M | $809.09M | 0.001 | +0.422% | 메이저 전반 안정화 | majors-btc-eth-stabilize-after-deceleration |
| ETH [truncation 11연속] | Aster | — | — | — | — | 직접 API도 403 재확인 | truncation-continues-eleventh-round |
| **ETHFI** [재악화 2회차] | Hyperliquid | $3.24M | $11.50M | 0.001 | -3.705% | 낙폭 확대 | ethfi-worsens-second-round |
| **FARTCOIN** [악화 2회차] | Hyperliquid | $4.22M | $29.70M | 0.001 | -2.169% | 마이너스 반전 후 낙폭 확대 | fartcoin-worsens-second-round |
| HYPER [무변화] | Hyperliquid | $0.06M | $0.20M | 0.001 | -1.068% | 대체로 무변화 유지 지속 | hyper-remains-roughly-flat |
| **APEX** [방향유지 3회차] | Hyperliquid | $0.22M | $0.62M | 0.001 | +1.615% | Bybit와 함께 플러스 유지 | apex-holds-positive-third-round |
| ALLO [서비스 중단] | OrangeX | — | — | — | — | — | orangex-service-outage-continues |
| ALLO [마이너스 반전] | Aster | $0.18M | $0.07M | 0.001 | -1.911% | B+B와 함께 플러스에서 마이너스로 | allo-flips-negative |
| ATOM [4벤뉴 플러스 2회차] | Aster | $0.01M | $1.69M | 0.004 | +1.067% | B+B·OKX·HL과 동조 유지 | atom-holds-positive-second-round-four-venues |
| **APR** [방향유지 4회차] | Aster | $0.27M | $0.34M | 0.001 | +10.385% | B+B·OKX와 동시 재가속 | apr-holds-positive-fourth-round |
...
1. **ACE**: 추가 가속(B+B +32.1%→+41.7%, HL +32.2%→+42.2%, Aster +31.9%→+41.4%) — WebSearch로도
...
31. **데이터**: OKX·Binance funding raw fraction 스팟체크 — 이번 회차 조회한 14개 이상
    종목에서 |funding|<0.01 범위 유지 확인, 신규 스케일 이상 없음 (funding-scale-spot-check-clean).
...
14건으로 직접 재조회했다. USD 거래량은 `volCcy24h × last`로 계산했다(OKX volCcy24h은
기초자산 수량 단위 — 단 KAITO·BICO 등 일부 심볼은 volCcy24h이 이미 vol24h와 동일해
ctVal=1로 추정, 계산방식은 유지); (d) 복수 거래소 종목의 `chg24`·`funding`은 이번 회차도
Binance+Bybit 거래량 가중평균으로 산출했다(OI는 두 거래소 합산); (e) Hyperliquid 데이터는
이번 회차도 CoinGecko `derivatives/exchanges/hyperliquid` 경유로 확보했다(직접 API `info`는
POST 전용이라 GET 전용 도구로 접근 불가); (f) **KAITO·BICO의 Binance 상장이 이번 회차도
유지 확인**됐다; (g) BTW·CASHCAT·HYNA 계열은 DEX에서만 상장이 확인돼 해당 섹션에서만
집계했다; (h) dYdX BTC/ETH/SOL은 `indexer.dydx.trade` REST(GET)로 raw JSON 필드를 직접
요청해 계산했다(`priceChange24H`가 달러 절대값임을 재확인해 `chg% = priceChange24H /
(oraclePrice - priceChange24H)`로 계산, `nextFundingRate` 필드를 raw fraction 그대로 반영,
OI는 `openInterest`(코인 수량) × `oraclePrice`, 거래량은 `volume24H` 필드 직접 사용).
**이번 회차 dYdX·HL 양쪽 모두 BTC·ETH가 감속에서 안정화로 전환**됐다; (i) **Aster 직접
API는 이번 회차도 403** — CoinGecko 파생거래소 id `aster`로 대부분 확보했다. ETH는
...
전부 확보했다 — KAITO·BICO·BEAT·MMT·CASHCAT·BTW는 CoinGecko Bybit 데이터에서도 여전히
"없음"으로 확인돼 구조적 미상장 판단이 유지된다; (l) KAITO의 OI는 OKX·Binance·HL 모두
USD환산 기준이나 산출 방법이 달라 직접 비교가 아닌 각자의 추세로만 해석해야 한다; (m)
**ACE의 이번 회차 추가 급등에 대해 WebSearch로 신규 촉매를 탐색**했으나 8/7·8/13 관련
보도(Bitget PoolX 상장)만 재확인됐고, 40%대까지 확대된 원인은 확인되지 않아 미상으로
남긴다; (n) **ACE는 OKX SWAP 티커 자체가 존재하지 않음**을 유지한다(이번 회차 개별
market/ticker 조회로도 재확인); (o) **HL SOL-USD**는 이번 회차도 별도 존재가 확인되지
않았다(HYNA:SOL-USD와 동일 값으로만 확인); (p) **OrangeX는 이번 회차도 전면 서비스
중단으로 funding 필드를 포함한 모든 데이터가 미확인**이다; (q) dYdX 메이저는 이번 회차
BTC·ETH·SOL 모두 감속·정체로 안정화 국면에 접어들었다; (r) **KAITO·BICO·BEAT·CASHCAT·BTW
Bybit는 이번 회차도 부재를 재확인**했다(구조적 미상장 성격, CoinGecko 경유로도 동일하게
미발견); (s) **BTW 집계 기준 명시**: CoinMarketCap이 보고하는 "Bitway"를 기준으로 삼아
집계를 유지한다 — 초소형 밈코인 "Banana Tape Wall"·"BitWhite"와는 별개 자산; (t)
**CASHCAT 현물 가격(cash-cat)**은 이번 회차 CoinGecko `simple/price` API로 재확인
성공했다(h24 -13.97%, 가격 $0.097164) — HL(-13.48%)·Aster(-13.58%)와 함께 3소스가 뚜렷한
마이너스로 수렴했다(지난 회차의 소스 간 괴리 완전 해소); (u) **ACE 언락 시각**은 지난
회차 tokenomist.ai 확인사항(8/18 언락 없음, 다음 언락 9/3)을 유지한다 — 이번 회차 추가
재확인은 하지 않았다; (v) **글로벌 시총·도미넌스**는 이번 회차 CoinGecko `/global`
...
Bybit 직접조회는 이번 회차 전면 403으로 회귀해 CoinGecko 대체 경로를 사용했다; (x)
> **[부모 세션 검증 경고 · 미해결]** 아래 "신규 스케일 이상 없음" 결론은 **OKX 14건에 한한 것**이며
> 다른 소스는 점검되지 않았다. 저장값을 소스별로 집계하면 중앙값이
> OKX 0.000072 / dYdX 0.000005 / Binance(직접) 0.000350 인 반면
> **Hyperliquid 0.001000 · Aster 0.003500 · Binance+Bybit(가중평균) 0.005000 · Bybit 0.005000** 으로
> **14~70배 차이**가 난다. 특히 `BICO`(Aster) `funding=-0.146` 은 chg24 가 -3.2%인데
> raw fraction 이라면 8시간당 -14.6% 라는 뜻이라 불가능한 수준이고, 퍼센트(-0.146%)로 읽어야 자연스럽다.
> **즉 직전 회차에 발견된 단위 오류와 같은 클래스가 다른 소스에 남아 있을 가능성이 있다.**
> 확인 요청을 보냈으며 결과가 오면 후속 커밋으로 정정한다. **이 회차의 funding 값은 소스 간 비교에 쓰지 말 것.**

**funding 단위 스팟체크**: 이번 회차 OKX `public/funding-rate` 14건을 직접 재조회한
결과 전부 raw fraction 범위(대략 -0.001~0.0007 수준)에 있어 신규 스케일 이상은
발견되지 않았다 — 지난 회차 발견된 KAITO·BICO·BEAT의 단위 오류(약 80~190배 과다기록)는
이번 회차엔 재현되지 않았다; (y) **신규 발견 핵심 8건**: ①ACE가 32%대에서 42%대로 추가
가속(원인 계속 미상), ②CASHCAT이 3소스 모두 뚜렷한 마이너스로 수렴(지난 회차 괴리
완전 해소), ③CAP가 마이너스에서 거의 손익분기권까지 회복, ④BSB가 양쪽 소스 모두
플러스로 수렴, ⑤HYPE·HYNA:HYPE가 다시 플러스로 반전, ⑥ALLO가 플러스에서 마이너스로
반전, ⑦Bybit 직접 API가 다시 403으로 회귀(직전 회차 복구와 반대), ⑧메이저 BTC·ETH·SOL이
감속에서 안정화 국면으로 전환; (z) **이번 회차 종합**: ①ACE 추가 가속(헤드라인, 원인
...
⑪BTW 확장 4회차, ⑫Bybit 직접API 403 회귀, ⑬funding 스케일 스팟체크 이상 없음,
⑭OrangeX 서비스 중단 29회차(약 59.75시간) 지속.
