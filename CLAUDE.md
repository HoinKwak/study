...
- **미션 #28(진행중)**: **15m/1h VALID 전략 발굴**. 지금까지 발굴·백테스트한 다수 전략 **전부 FAIL**(backtest-reviewer로 재검증해 거짓 FAIL 아님 확인). 최근(8/2 오후): OU 모멘텀 연장 정식 스위트 **FAIL·VALID**(fragile-positive 기각 — OOS 1.101이나 top5 제거만으로 0.978 붕괴, OOS 순익의 44%가 거래 1건. **z-score 계열 4종(칼만·프리미엄·OU fade·모멘텀연장) 최종 FAIL 확정**), CUSUM+트리플배리어 **FAIL·VALID**(전 종목·12변형 PF<1, 리뷰어 방향반전 실측 양방향 무엣지, 지속 음성-PF 복리 사이징 시 시뮬 계좌 붕괴 발견 → 유사 전략은 IS/OOS equity 리셋·고정명목 권고). 신규 스펙 5종 추가(CUSUM·52주 신고가·코인베이스 프리미엄·SSR 등, 총 217). 8/2 오전: 아시아세션 런던돌파·RSI DCA 래더(30x 청산 46~59%)·OU fade 3종 FAIL·VALID. 8/1: 프리미엄인덱스 Z스코어 FAIL·VALID, RSI 히든 다이버전스 HOLD·VALID. **scalp15m이 여전히 유일 라이브 전략**. 미검증 대기: VPIN·AlphaTrend·ICT 브레이커·OI 크라우딩·52주 신고가(포트폴리오 엔진 필요)·코인베이스 프리미엄·SSR(외부 데이터 필요) 등.
